...
class ExpenseCategory {
  ...
  Map<String, dynamic> toMap() => {
        ...
        'totalAmount': totalAmount
            .toString(), // our db won't be able to store double values so we convert it to a string
        // not gonna store the icons in database. that's too much work.
      };

  // when we retrieve the data from the db it will be a 'Map'.
  // for our app to undestand the data, we need to convert it back to a 'Expense Category'
